function A = quantizationMedianCutBlur(recursions,imagename)
...
outputImage = reshape(A_back,m,n,o);

%Write the final image
outputImage = uint8(outputImage);
imwrite(outputImage,strcat('OutputImages/',imagename,'_QuantizationMedianCutBlur',num2str(recursions),'.jpg'),'jpeg');
end
